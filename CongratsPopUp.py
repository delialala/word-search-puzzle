...
# will pop up if player finds all the words
class CongratsPopUp():
    ...
    # draw the congrats pop up window
    def draw(self):
        # draw the window
        ...
        # draw the pop up congrats window's messages
        ...
        text1_text = text1_font.render("YOU DID IT!", True, Constants.DARKGREEN)

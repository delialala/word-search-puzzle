...
# this button is used in Congrats and Uhoh pop-up windows
# it takes the player to the intro game page and resets the game
class MainScreenButton(Button.Button):
